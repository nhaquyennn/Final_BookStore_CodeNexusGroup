...
class KhuyenMaiController
{
  ...
  {
    if (
      isset($data['TenKhuyenMai'], $data['PhanTramGiamGia'], $data['NgayBatDau'], $data['NgayKetThuc']) &&
  ...
  {
    if (
      isset($data['MaKhuyenMai'], $data['TenKhuyenMai'], $data['PhanTramGiamGia'], $data['NgayBatDau'], $data['NgayKetThuc']) &&
      !empty($data['TenKhuyenMai'])
    ) {
      try {
