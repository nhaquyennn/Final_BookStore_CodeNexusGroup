          ...
          <div class="card-body">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
              <form method="GET" action="" class="d-flex flex-grow-1 align-items-center">
                <input type="text" class="form-control me-2" name="search" placeholder="Nhập mã khuyến mãi"
              ...
              <tbody>
                <?php if ($searchResult): ?>
                  ...
                  <tr>
                    ...
                    <td><?= isset($searchResult['PhanTramGiamGia']) ? $searchResult['PhanTramGiamGia'] . '%' : 'N/A' ?>
                    </td>
                    ...
                    <td>
                      <a href="crud/edit.php?id=<?= $searchResult['MaKhuyenMai'] ?>"
                        class="btn btn-warning btn-sm">Sửa</a>
                      <a href="crud/delete.php?id=<?= $searchResult['MaKhuyenMai'] ?>" class="btn btn-danger btn-sm"
                  ...
                  <?php foreach ($khuyenMaiList as $km): ?>
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="crud/delete.php?id=<?= $km['MaKhuyenMai'] ?>" class="btn btn-danger btn-sm"
                          onclick="return confirm('Bạn có chắc chắn muốn xóa không?');">Xóa</a>
                      </td>
                    </tr>
                  <?php endforeach; ?>
