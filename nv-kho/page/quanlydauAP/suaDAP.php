                ...
                <div class="col-12">
                    ...
                    <form class="form-createAP" action="#" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="tenDanhMuc" value="<?php echo $tenDAP?>" name="tendauAP">
                        </div>


                        <div class="mb-3">
                            <label class="form-label fw-bold">Tác giả</label>
                            <input type="text" class="form-control" id="moTa" value="<?php echo $tacGia ?>" name="tacGia"></input>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="soluong" value="<?php echo $soLuong ?>" name="soLuong">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" class="form-control" id="hinhAnh" value="<?php echo $hinhAnh ?>" name="hinhAnh">
                        </div>
                    </div>

                       
                        <div class="mt-4 ml-3">
                            <a href="index.php?page=quanlydauAP"><button type="submit" class="btn btn-primary" name="suaDAP">Lưu</button></a>
