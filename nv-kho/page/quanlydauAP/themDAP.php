                ...
                <div class="col-12">
                    ...
                    <form class="form-createAP" action="#" method="POST" enctype="multipart/form-data">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="madauAP" placeholder="Nhập tên ấn phẩm" name="madauAP">
                        </div>
                        <div class="mb-3">
                            <label class="form-label fw-bold">Tên đầu ấn phẩm</label>
                            <input type="text" class="form-control" id="tenAnPham" placeholder="Nhập tên ấn phẩm" name="tendauAP">
                        </div>
                        <div class="row g-3">
                            <div class="col-md-3">
                                <label class="form-label fw-bold">Tác giả</label>
                                <input type="text" class="form-control" id="tacGia" placeholder="Tác giả" name="tacGia">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label fw-bold">Nhà xuất bản</label>
                                <input type="text" class="form-control" id="NXB" placeholder="Nhà xuất bản" name="nhaXB">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label fw-bold">Số lượng</label>
                                <input type="number" class="form-control" id="soluong" placeholder="Số lượng" name="soLuong">
                            </div>
                            <div class="col-md-3">
                    ...
                    if(isset($_POST['themDAP'])){
                        ...
                        if($conn){
                            move_uploaded_file($hinhAnh['tmp_name'], '../img/' . $file_hinh);
                            ...
                            if($conn->query( $str)){
                                echo "<script>alert('Them thanh cong'); window.location.href='index.php?page=quanlydauAP'</script>";
                            }else {
                                echo "<script>alert('Them that bai'); window.location.href='index.php?page=quanlydauAP'</script>";
                            }
                        }
                    }
                    ?>
